...
<div class="content">
    <div class="wrap">
        <div id="main" role="main">
            <ul id="tiles">
                <% if(s.search(request.getParameter("keyword")).isEmpty()){ %>
                <!-- These are our grid blocks -->
                <li>
                        <img style="border-radius: 10px; margin-left: auto; margin-right: auto" src="images/sad.png" />
                </li>
                   
                <% }else{ %>
                <% for (VideoPojo ip : s.search(request.getParameter("keyword"))) {%>
